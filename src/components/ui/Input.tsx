    ...
    return (
      <div className={cn("flex flex-col gap-2", containerClassName)}>
        ...
        <div className="group relative">
          {icon && (
            <span className="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-[20px] text-[var(--text-muted)] transition-colors group-focus-within:text-[var(--gold)]">
              {icon}
            </span>
          )}
          <input
            ...
            className={cn(
              ...
              icon ? "border-[var(--border)] pl-12 pr-4" : "border-[var(--border)] px-4",
