        ...
        {DAY_OPTIONS.map((day) => {
          ...
          return (
            ...
            >
              ...
              <div className="mt-1 text-[11px] text-[var(--text-secondary)]">{day.label}</div>
            </button>
          );
        })}
      </div>
  ...
  return (
    ...
    >
      <div className="space-y-5 pb-1">
        ...
        {error ? (
          <div className="rounded-2xl border border-[var(--danger)]/50 bg-[var(--danger)]/10 px-4 py-3 text-sm font-semibold text-[var(--danger)]">
            {error}
          </div>
        ) : null}
      </div>
