          ...
          <div className="flex flex-col gap-2">
            <div className="flex flex-wrap items-center gap-1.5">
              ...
              <div className="inline-flex flex-wrap items-center gap-1 rounded-xl border border-[var(--border)]/70 bg-[var(--bg-raised)] px-1.5 py-1">
                <Button variant="ghost" onClick={exportFilteredCoursesCsv} className="gap-1.5 px-2 text-[var(--text-secondary)]">
                  <span className="material-symbols-outlined text-[18px]">file_download</span>
                  <span>Export CSV</span>
                </Button>
                <Button variant="ghost" onClick={() => { setFilters(DEFAULT_FILTERS); setActiveSavedViewId(null); }} className="gap-1.5 px-2 text-[var(--text-secondary)]">
